...
extern dfa_node_t *lexerNodeMap[MAX_LEXER_NODES];
extern lr_state_t *parserStateMap[MAX_PARSER_STATES];
extern symbol_table_item_t *lexemeMap[MAP_SIZE];
extern symbol_table_item_t *terminalMap[MAP_SIZE];
extern symbol_table_item_t *nonTerminalMap[MAP_SIZE];
...
void createReduceRule(char key[MAX_TERMINAL_SIZE],
  ...
  reduceRule->numElements = numElements;
